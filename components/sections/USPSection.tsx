...
const USPs = [
  {
    ...
    desc: "Kelas online berkualitas tinggi langsung dari instruktur profesional. Jadwal fleksibel, koneksi nyata.",
  },
  {
    icon: MapPin,
    label: "Onsite",
    title: "Jakarta · Bekasi · Bandung",
    desc: "Studio kami tersebar di tiga kota. Rasakan pengalaman belajar tatap muka dalam suasana yang intim dan kondusif.",
  },
  {
    icon: Music2,
    label: "Band Management",
    title: "Lebih dari Sekadar Kursus",
  ...
  },
  {
    ...
    desc: "Program dirancang khusus untuk setiap tahap kehidupan — dari 5 tahun hingga lansia, pemula hingga mahir.",
  },
  {
    icon: Award,
    label: "Bersertifikat",
    title: "Instruktur Tersertifikasi",
    desc: "Setiap pengajar telah melalui seleksi ketat dan memiliki rekam jejak profesional di industri musik.",
  },
];
